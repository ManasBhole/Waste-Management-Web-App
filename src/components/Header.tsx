        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">MB Waste Management</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">Save Earth</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
